...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            #region TEST CODE
            book = driver.FindElement(By.CssSelector("li.book.selected > h4:nth-child(1)"));
            #endregion
        ...
        public void ShouldCheckNumberOfBooks()
        {
            ...
            #region TEST CODE
            books = driver.FindElements(By.CssSelector("ul > li.book"));
            #endregion
        ...
        public void ShouldCheckLinksDomain()
        {
            ...
            #region TEST CODE
            links = driver.FindElements(By.CssSelector("ul > li a"));
            #endregion
